...
const features = [
  ...
  },
  {
    ...
    body: "Талууд, сарын түрээс, барьцаа, эхлэх/дуусах огноо, төлбөрийн өдрийг гэрээнээс шууд салгаж авна.",
  },
  {
    icon: Mail,
    title: "Засварын захидал",
    body: "Олдсон зөрчил дээр тулгуурлан түрээслүүлэгч рүү илгээхэд бэлэн албан ёсны захидлыг боловсруулж өгнө.",
  },
  {
    icon: BellRing,
    title: "Хугацааны сануулга",
    body: "Гэрээ дуусах хугацаа ойртоход сануулж, шинэчлэх эсэхээ шийдэх завыг тань олгоно.",
  },
  {
    icon: ScanLine,
