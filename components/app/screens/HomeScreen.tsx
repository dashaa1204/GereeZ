...
export function HomeScreen({
  ...
  // The upload zone is a prototype stub — it opens the most recent contract's
  // audit (or the contracts list when there is none), matching the figma flow.
  const openUpload = () =>
    router.push(recent ? `/contracts/${recent.id}` : "/contracts");
  ...
  return (
    <div className="space-y-5">
      ...
      <div
        ...
        onDrop={(e) => { e.preventDefault(); setDragging(false); openUpload(); }}
